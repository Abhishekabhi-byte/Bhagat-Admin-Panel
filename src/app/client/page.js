...
export default function Client() {
  ...
  const handleCreateClient = (e) => {
    ...
    // Clear states directly without breaking matching rendering paths
  ...
  return (
    <div className="space-y-5 max-w-7xl mx-auto py-4 px-4">
      {/* Table Card wrapper */}
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={() => {
          ...
          <div className="bg-white rounded-xl w-full max-w-lg p-6 shadow-xl border border-red-200" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="space-y-5">
              {/* Images Section */}
              <div className="flex items-center justify-around p-4 bg-gradient-to-r from-[#7d3431]/5 to-[#cb8c89]/5 rounded-xl border border-red-200/50">
                <div className="flex flex-col items-center gap-1">
                  <div className="w-20 h-20 rounded-lg overflow-hidden border-2 border-[#7d3431]/20 shadow-sm bg-white">
                    <img 
                  ...
                  <span className="text-[10px] font-bold text-black/50 uppercase tracking-wider">Company</span>
                </div>
                
                <div className="w-12 h-0.5 bg-gradient-to-r from-[#7d3431]/20 to-[#cb8c89]/20" />
                
                <div className="flex flex-col items-center gap-1">
                  <div className="w-20 h-20 rounded-full overflow-hidden border-2 border-[#7d3431]/20 shadow-sm bg-white">
                    <img 
                  ...
                  <span className="text-[10px] font-bold text-black/50 uppercase tracking-wider">Client</span>
                </div>
              </div>
              ...
              <div className="space-y-3.5">
                ...
                <div>
                  ...
                  <p className="text-sm text-black/70 bg-[#7d3431]/5 px-3 py-2 rounded-lg border border-red-200/50 min-h-[60px] whitespace-pre-wrap">
